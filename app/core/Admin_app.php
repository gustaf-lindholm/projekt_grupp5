...
class Admin_app
{
    ...
    public function __construct()
    {
        ...
        if (file_exists(ADMIN_CONTROLLER . $url[0] . '.controller.php'))
        {
        ...
        if (!is_file(ADMIN_CONTROLLER . $this->controller . '.controller.php')) {
            $this->controller = ADMIN_DEFAULT;
        }
        require_once ADMIN_CONTROLLER . $this->controller . '.controller.php';
